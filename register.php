...
<?php
    ...
    echo '<h4 style="font-family:helvetica">Password Recovery</h4>
      ...
      <form action="" method="POST">
        ...
        <label style="font-family:helvetica;">Select your country</label>
        <select name="country" class="round" id="country" required>
        
        <optgroup id="country-optgroup-Africa" label="Africa">
            <option value="DZ" label="Algeria" selected>Algeria</option>
        ...
        <optgroup id="country-optgroup-Asia" label="Asia">
            ...
            <option value="YD" label="Peoples Democratic Republic of Yemen">Peoples Democratic Republic of Yemen</option>
